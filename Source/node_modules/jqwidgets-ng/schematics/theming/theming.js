...
function addThemeToAppStyles(options) {
    return function (host, context) {
		...
		if (themeName !== 'default' && themeName !== 'base') {
            insertPrebuiltTheme(project, host, "jqx.base", workspace, context.logger);
        ...
        if (themeName === 'custom') {
            ...
            insertPrebuiltTheme(project, host, 'jqx.' + themeName, workspace, context.logger);
